#include "thermal_control/radiators.hpp"
...
{
  vent_service_ = this->create_service<thermal_control::srv::VentHeat>(
...
void RadiatorController::handle_vent_request(
  const std::shared_ptr<thermal_control::srv::VentHeat::Request> request,
  std::shared_ptr<thermal_control::srv::VentHeat::Response> response)
{
...
int main(int argc, char **argv)
{
  ...
  rclcpp::spin(std::make_shared<thermal_control::RadiatorController>());
  rclcpp::shutdown();
  return 0;
}
