...
private:
  ...
  void handle_heatflow(
    const std::shared_ptr<thermal_control::srv::NodeHeatFlow::Request>,
    std::shared_ptr<thermal_control::srv::NodeHeatFlow::Response>);
  ...
  rclcpp::Service<thermal_control::srv::NodeHeatFlow>::SharedPtr heatflow_server_;
