...
#include "thermal_control/msg/thermal_link_flows.hpp"
#include "thermal_control/srv/node_heat_flow.hpp"
#include <chrono>
...
private:
  ...
  rclcpp::Publisher<thermal_control::msg::ThermalNodeDataArray>::SharedPtr node_pub_;
  rclcpp::Publisher<thermal_control::msg::ThermalLinkFlowsArray>::SharedPtr link_pub_;
  rclcpp::Client<thermal_control::srv::NodeHeatFlow>::SharedPtr cooling_client_;
